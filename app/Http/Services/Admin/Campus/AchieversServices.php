...
use App\Http\Repository\Admin\Campus\AchieversRepository;
use Carbon\Carbon;
...
use Config;
class AchieversServices
{
	protected $repo;
    public function __construct(){
        $this->repo = new AchieversRepository();
    }
    ...
    public function updateAll($request){
        try {
            ...
            if ($request->hasFile('image')) {
                ...
                $slide_data = AchieversModel::find($return_data['last_insert_id']);
