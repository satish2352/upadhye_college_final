                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select name="imageType" id="dropdown" class="form-control">
                                                <option value="all" {{ $editData->imageType == 'all' ? 'selected' : '' }}>ALL</option>
                                                <option value="trending" {{ $editData->imageType == 'trending' ? 'selected' : '' }}>Trending</option>
                                                <option value="popularity" {{ $editData->imageType == 'popularity' ? 'selected' : '' }}>Popularity</option>
                                                <option value="featured" {{ $editData->imageType == 'featured' ? 'selected' : '' }}>Featured</option>
                                            </select>
                                            @if ($errors->has('imageType'))
                                                <span class="red-text"><?php echo $errors->first('imageType', ':message'); ?></span>
                                            @endif
                                        </div>
                                    </div>
