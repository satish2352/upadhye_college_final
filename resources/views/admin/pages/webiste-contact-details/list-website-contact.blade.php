                                        ...
                                        <table id="order-listing" class="table table-bordered">
                                            ...
                                            @forelse ($getOutput as $item)
                                                <tr>
                                                    ...
                                                    <td>{{ $item->title ? strip_tags($item->title) : '' }}</td>
                                                    <td>{{ $item->short_description ? strip_tags($item->short_description) : '' }}</td>
                                                    <td>{{ $item->long_description ? strip_tags($item->long_description) : '' }}</td>
                                                    <td><img class="img-size"
                                                            src="{{ Config::get('DocumentConstant.ADDITIONAL_SOLUTIONS_VIEW') }}{{ $item->image }}"
                                                            alt="{{ $item->title ? strip_tags($item->title) : 'Image' }}" />
                                                    </td>
                                                    <td>
                                                        <label class="switch">
